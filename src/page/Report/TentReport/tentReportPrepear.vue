    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                <h1 class="text-site-blue text-xl font-semibold mb-3">عملية التحضير للخيمة 3  الباقة  باقة (1) D-19 الخيام المطورة</h1>
                <div class="flex items-center gap-12">
                    <h1 class="text-site-blue text-xl font-semibold">الموقع : عرفات</h1>
                    <h1 class="text-site-blue text-xl font-semibold">الجنس : نساء</h1>
                </div>
                <hr>
