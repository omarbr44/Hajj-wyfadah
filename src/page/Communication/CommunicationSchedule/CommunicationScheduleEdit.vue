    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                <h1 class="text-site-blue text-xl font-semibold">عرض الرسالة
                </h1>
                <hr>
                <h1 class="text-lg font-semibold my-4">محتوى الرسالة</h1>
                <textarea
                    class="rules-section w-[90%] bg-white border border-[#BDBDBD] py-2 px-5 rounded-3xl h-52"
                    v-model="searchFilter"
                    >

                </textarea>
                <div class="flex justify-between items-center px-10 my-10 w-f">
                    <div class="flex flex-col items-center gap-3 w-[40%]">
                            <p class="font-semibold mb-3 w-full text-right">تاريخ الإرسال</p>
                            <VueDatePicker format="MM/dd/yyyy" :enable-time-picker="false" auto-apply />
                    </div>  
                    <div class="flex flex-col items-center gap-3 w-[40%]">
                            <p class="font-semibold mb-3 w-full text-right">وقت الإرسال</p>
                            <VueDatePicker time-picker auto-apply />
                    </div>  
                </div>
                <h1 class="text-lg font-semibold my-4">محتوى الرسالة</h1>
                <hr>
                <div class="w-[40%] relative my-10">
                    <SearchComponent
                    placeholder="ابحث برقم الجوال - اسم الحاج "
                 ...
                 <div class="p-4">
                    <div class="flex items-center justify-between">
                        <button  class="bg-site-blue w-fit text-white rounded-xl p-4 flex items-center my-8">
                            <span class="font-bold text-xl px-6">تعديل</span>
                        </button>
                        <button  class="w-fit text-red-600 rounded-xl p-4 flex items-center my-8">
                            <span class="font-bold text-xl px-8 py-1">الغاء</span>
                        </button>
                    </div>
                 </div>
            </div>
