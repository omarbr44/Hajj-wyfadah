    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div>
            <div class="rtl-d px-10 pt-28">
                <h1 class="text-xl font-bold text-site-blue mb-5">إضافة باص جديد</h1>
                <div class="w-full p-4 border border-[#DADADA] rounded-2xl flex flex-wrap gap-4 gap-y-10">
                    <div class="w-[99%]">
                        ...
                        <p class="font-semibold text-[#008093]">تفعيل القطار</p>
                    ...
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">اسم المرشد<span class="text-red-500">*</span></p>
                    ...
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">اسم المشرف<span class="text-red-500">*</span></p>
                        <Select v-model="bransh.city" :options="cities" optionLabel="name_ar" 
                                    placeholder="اختر من القائمة" overlayClass="!bg-white rtl-d p-2" class=" flex justify-between items-center px-4 py-2 border border-[#BDBDBD] rounded-xl"
                                    :pt="{overlay:' shadow-xl'}">
                                    <template #value="slotProps">
                    ...
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">اختر الموقع<span class="text-red-500">*</span></p>
                        <Select v-model="bransh.city" :options="cities" optionLabel="name_ar" 
                                    placeholder="اختر من القائمة" overlayClass="!bg-white rtl-d p-2" class=" flex justify-between items-center px-4 py-2 border border-[#BDBDBD] rounded-xl"
                                    :pt="{overlay:' shadow-xl'}">
                                    <template #value="slotProps">
                    ...
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3"> جنسيات المجموعات<span class="text-red-500">*</span></p>
                        <Select v-model="bransh.city" :options="cities" optionLabel="name_ar" 
                                    placeholder="اختر من القائمة" overlayClass="!bg-white rtl-d p-2" class=" flex justify-between items-center px-4 py-2 border border-[#BDBDBD] rounded-xl"
                                    :pt="{overlay:' shadow-xl'}">
                                    <template #value="slotProps">
                    ...
                    <div class="w-[48%]">
                        <div class="relative" >
                        <p class="text-black font-semibold w-[50%] mb-3">مكان الوصول<span class="text-red-500">*</span></p>
                        <input 
                        type="text" 
                        class="w-full relative bg-[#f9f9f9] border border-[#BDBDBD] p-2 rounded-xl"
                    ...
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">اسم السائق<span class="text-red-500">*</span></p>
                        <input 
                        type="text" 
                        class="w-full relative bg-[#f9f9f9] border border-[#BDBDBD] p-2 rounded-xl"
                        placeholder="اكتب اسم سائق الباص">
                        <p v-if="requestConditions?.error?.capacity" class="text-red-500 mt-1">{{ requestConditions.error.capacity }}</p>
                    </div>
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">رقم جوال السائق<span class="text-red-500">*</span></p>
                        <input 
                        type="text" 
                        class="w-full relative bg-[#f9f9f9] border border-[#BDBDBD] p-2 rounded-xl"
                        placeholder="مثال : 5776787657">
                        <p v-if="requestConditions?.error?.capacity" class="text-red-500 mt-1">{{ requestConditions.error.capacity }}</p>
                    </div>
                    <div class="flex justify-center w-full">
                        <div class="w-[48%]">
                            <p class="text-black font-semibold w-[50%] mb-3">موديل<span class="text-red-500">*</span></p>
