    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                <RouterLink to="trip-add/add" class="bg-site-blue w-fit text-white rounded-xl p-4 flex items-center gap-2 my-8">
                    <PlusIcon />
                    <span class="font-bold">إضافة رحلة</span>
                </RouterLink>
                ...
                :canDelete="true">
                    <template v-slot:header>
                        <tr>
                            <th scope="col">اسم الرحلة</th>
                            <th scope="col">الموقع</th>
                            <th scope="col">الوجهة</th>
                            <th scope="col">توزيع الباص</th>
                            <th scope="col">كشف توزيع الباص</th>
                    ...
                    <template v-slot:body>
                        <tr v-for="index in 5" >
                            ...
                            <td>المطار</td>
                            <td class=" bg-green-300 text-green-500 text-lg font-bold" >تم التوزيع</td>
                            <td>
                            ...
                            <td class="flex items-center justify-center gap-5 pt-[10%]">
                                <RouterLink :to="'trip-add/1'" class="flex items-center gap-2">
                                    <EditIcon />
                    ...
                    <template v-slot:delete-modal-1>
                        <h1 class="text-center text-3xl font-bold mb-5">هل انت متأكد من رغبتك في حذف هذه الرحلة ؟</h1>
                        <p class="text-center mb-8">سيؤدي حذف هذه الرحلة إلى إزالة جميع المعلومات والبيانات المتعلقة بها، وقد يؤثر على سير العمل والأنشطة الخاصة بالشركة. يرجى التحقق من تأثيرات هذا الإجراء والتأكد من قرارك.
                        </p>
                    </template>
                    <template v-slot:delete-modal-2>
                        <h1 class="text-xl font-bold mb-5">لا يمكنك حذف الرحلة !
                        </h1>
                        <p class="mb-8">
                            الرحلة الحالية مرتبطة بتوزيع معين يجب إلغاء اي توزيع مرتبط بهذه الرحلة لتتمكن من حذفها 
                        </p>
                    </template>
                </TableComponent>
                <PaginationComponent
