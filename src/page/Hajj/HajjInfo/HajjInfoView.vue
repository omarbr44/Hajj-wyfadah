    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                ...
                <RouterLink to="hajj-info-add/add" class="bg-site-blue w-fit text-white rounded-xl p-4 flex items-center gap-2 my-8">
                ...
                :canDelete="true">
                    <template v-slot:header>
                        <tr>
                            ...
                            <th scope="col">مقعد
                                منى</th>
                            <th scope="col">عرفات</th>
                            <th scope="col">رقم الباص</th>
                            <th scope="col">الجنس</th>
                            <th scope="col">رقم المخيم</th>
