...
<div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                <h1 class="text-site-blue text-xl font-semibold mb-10">مرفقات الحاج</h1>
                <RouterLink to="/hajj-attachment-add" class="bg-site-blue w-fit text-white rounded-xl p-4 flex items-center gap-2 my-8">
                    <PlusIcon />
                ...
                :canDelete="true">
                    ...
                    <template v-slot:body>
                        ...
                        <tr v-for="(attach,index) in hajjAttachments" :key="index">
                            <td>
                                <RouterLink to="hajj-info-add/add" class="text-site-blue font-bold" >{{ attach.name }}</RouterLink>
                            </td>
                            <td>{{ attach.type }}</td>
                            <td class="w-1/2">
                            ...
                            <td class="flex items-center justify-center gap-5">
                                <RouterLink to="/hajj-attachment-add" class="flex items-center gap-2">
                                    <EditIcon />
                                    <span class="text-[#46814F]">تعديل</span>
                                </RouterLink >
