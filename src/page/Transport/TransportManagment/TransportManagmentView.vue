    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                <RouterLink to="transport-add/add" class="bg-site-blue w-fit text-white rounded-xl p-4 flex items-center gap-2 my-8">
                    <PlusIcon />
                    <span class="font-bold">إضافة باص</span>
                </RouterLink>
                ...
                :canDelete="true">
                    <template v-slot:header>
                        <tr>
                            ...
                            <th scope="col">مجموع الركاب الحالي</th>
                    ...
                    <template v-slot:body>
                        <tr v-for="index in 5" >
                            ...
                            <td class="flex items-center justify-center gap-5 pt-[22%]">
                                <RouterLink :to="'transport-add/1'" class="flex items-center gap-2">
                                    <EditIcon />
                    ...
                    <template v-slot:delete-modal-1>
                        <h1 class="text-center text-3xl font-bold mb-5">هل أنت متأكد أنك ترغب في حذف هذا الباص   </h1>
                        <p class="text-center mb-8">الباص الحالي مرتبط بتوزيع معين يجب إلغاء اي توزيع مرتبط بهذا الباص لتتمكن من حذفها 
                        </p>
                    </template>
                    <template v-slot:delete-modal-2>
                        <h1 class="text-xl font-bold mb-5">لا يمكنك حذف هذا الباص
                        </h1>
                        <p class="mb-8">
                            الباص الحالي مرتبط بتوزيع معين يجب إلغاء اي توزيع مرتبط بهذا الباص لتتمكن من حذفه 
                        </p>
                    </template>
                </TableComponent>
                <PaginationComponent
