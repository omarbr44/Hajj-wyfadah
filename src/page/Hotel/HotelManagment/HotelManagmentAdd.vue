    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div>
            <div class="rtl-d px-10 pt-28">
                <h1 class="text-xl font-bold text-site-blue mb-5">إضافة فندق جديد</h1>
                <div class="w-full p-4 border border-[#DADADA] rounded-2xl flex flex-wrap gap-4 gap-y-10">
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">اسم الفندق <span class="text-red-500">*</span></p>
                        <input 
                        type="text" 
                    ...
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">عدد الغرف</p>
                        <input 
                        type="number" 
                        class="w-full relative bg-[#f9f9f9] border border-[#BDBDBD] p-2 rounded-xl"
                        placeholder="0">
                    ...
                    <div class="w-[48%]">
                        <div class="relative" >
                        <p class="text-black font-semibold w-[50%] mb-3">رابط موقع الفندق<span class="text-red-500">*</span></p>
                        <input 
                        type="text" 
                        class="w-full relative bg-[#f9f9f9] border border-[#BDBDBD] p-2 rounded-xl"
                        placeholder="رابط موقع الفندق في خريطة قوقل">
                        <LocationIcon />
                        <p v-if="requestConditions?.error?.place_ar" class="text-red-500 mt-1">{{ requestConditions.error.place_ar }}</p>
                        </div>
                    </div>
                    <div class="w-[48%]">
                        <p class="text-black font-semibold w-[50%] mb-3">عنوان الفندق<span class="text-red-500">*</span></p>
                        <input 
                        type="text" 
                        class="w-full relative bg-[#f9f9f9] border border-[#BDBDBD] p-2 rounded-xl"
                        placeholder="اكتب عنوان الفندق">
                        <p v-if="requestConditions?.error?.capacity" class="text-red-500 mt-1">{{ requestConditions.error.capacity }}</p>
                    </div>
                    <div class="flex justify-center w-full">
                        <div class="w-[48%]">
                            <p class="text-black font-semibold w-[50%] mb-3">بطاقة الفندق<span class="text-red-500">*</span></p>
