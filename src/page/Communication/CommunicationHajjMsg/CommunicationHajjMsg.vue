    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-5 pt-28">
                <h1 class="text-site-blue text-xl font-semibold">رسائل الحاج (ABDUL HAMEED MUHAMMAD SIDDIQ )  السابقة
                </h1>
                        ...
                        <tr v-for="index in 5" >
                            ...
                            <td class="">
                                <div class="flex items-center justify-center gap-2 border-0 relative w-[7rem]">
                                    <RouterLink :to="'/communication-hajjmsgs/1/details/1'" class="flex items-center gap-1">
