    ...
    <div class="w-[80%] bg-[#f9f9f9] pb-8 min-h-screen">
        <div>
            <div class="rtl-d px-10 pt-28">
                <h1 class="text-xl font-bold text-site-blue mb-5">عنوان المقال</h1>
                <div class="w-full p-4 border border-[#DADADA] rounded-2xl">
                    <div class="w-full flex gap-8 mb-6">
                        <p class="text-black font-semibold mb-3 w-[20%]">الأسم باللغة العربية</p>
                        <input 
                        type="text" 
                    ...
                    <div class="w-full flex gap-8 mb-6">
                        <p class="text-black font-semibold mb-3 w-[20%]">الصورة</p>
                        <FileInputComponent @changeFile="changeFile" />
                    </div> 
                    <div class="w-full flex gap-8 mb-6">
                        <p class="text-black font-semibold mb-3 w-[20%]">محتوي المقال</p>
                        <textarea
