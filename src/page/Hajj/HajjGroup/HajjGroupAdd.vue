    ...
    <div class="w-[80%] bg-[#f9f9f9]">
        <div v-if="loadPage">
            <div class="rtl-d px-10 pt-28">
                <h1 class="text-xl font-bold text-site-blue mb-5">تعديل المجموعة</h1>
                <hr>
                ...
                <div class="w-full p-4 border border-[#DADADA] rounded-2xl flex flex-wrap gap-y-4">
                    <div class="w-[45%]">
                        ...
                        placeholder="سعودي / اندونسي">
                        <p v-if="requestConditions?.error?.name_ar" class="text-red-500 mt-1">{{ requestConditions.error.name_ar }}</p>
                    </div>
                    <div class="w-[8%]"></div>
                    <div class="w-[45%]">
                        <p class="text-black font-semibold w-[50%] mb-3">جنسيات المجموعة<span class="text-red-500">*</span></p>
                    ...
                    <div class="w-[45%]">
                        <p class="text-black font-semibold w-[50%] mb-3">رقم الخيمة<span class="text-[#DADADA]">( اختياري )</span></p>
                        <Select v-model="fromCountry" :options="[1,2]" optionLabel="name" 
                                    placeholder="" overlayClass="!bg-white rtl-d p-2" class=" flex justify-between items-center px-4 py-2 border border-[#BDBDBD] rounded-xl"
                                    :pt="{overlay:' shadow-xl'}">
                                    <template #value="slotProps">
                    ...
                    <div class="w-[8%]"></div>
                    <div class="w-[45%]">
                        <p class="text-black font-semibold w-[50%] mb-3">الباص<span class="text-[#DADADA]">( اختياري )</span></p>
                        <Select v-model="fromCountry" :options="[1,2]" optionLabel="name" 
                                    placeholder="" overlayClass="!bg-white rtl-d p-2" class=" flex justify-between items-center px-4 py-2 border border-[#BDBDBD] rounded-xl"
                                    :pt="{overlay:' shadow-xl'}">
                                    <template #value="slotProps">
                    ...
                    <div class="w-full">
                        ...
                        placeholder="أضف ملحوظة متعلقة بهذه المجموعة ">
                        <p v-if="requestConditions?.error?.name_ar" class="text-red-500 mt-1">{{ requestConditions.error.name_ar }}</p>
                    </div>
