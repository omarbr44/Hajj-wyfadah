<template>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" style="shape-rendering: auto; display: block; background: rgb(255, 255, 255);" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle fill="#d9d9d9" r="10" cy="50" cx="84">
    ...
    <animate begin="0s" values="#d9d9d9;#5fc1cf;#d9d9d9;#5fc1cf;#d9d9d9" keyTimes="0;0.25;0.5;0.75;1" calcMode="discrete" dur="1s" repeatCount="indefinite" attributeName="fill"></animate>
</circle><circle fill="#d9d9d9" r="10" cy="50" cx="16">
...
</circle><circle fill="#5fc1cf" r="10" cy="50" cx="50">
...
</circle><circle fill="#d9d9d9" r="10" cy="50" cx="84">
...
</circle><circle fill="#5fc1cf" r="10" cy="50" cx="16">
