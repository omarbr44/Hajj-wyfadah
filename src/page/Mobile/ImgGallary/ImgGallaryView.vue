    ...
    <div class="w-[80%] bg-[#f9f9f9]">
            <div v-if="loadPage">
                <div class="rtl-d px-5 pt-28">
                    <h1 class="text-site-blue text-xl font-semibold mb-10">معرض الصور</h1>
                    <RouterLink to="mobile-imggallary-add/add" class="bg-site-blue w-fit text-white rounded-xl p-4 flex items-center gap-2 my-8">
                        <PlusIcon />
                        <span class="font-bold">أضف صور جديدة</span>
                    </RouterLink>
                    ...
                    :canDelete="true">
                        <template v-slot:header>
                            <tr>
                                ...
                                <th scope="col">تفاصيل الالبوم</th>
                        ...
                        <template v-slot:body>
                            ...
                            <tr v-for="index in 5" >
                                <td>صورنا ف الكعبة</td>
                                <td>صور الحج رقم 1</td>
                                <td class="flex items-center justify-center gap-5">
                                    <RouterLink :to="'mobile-imggallary-add/1'" class="flex items-center gap-2">
                                        <EditIcon />
                                        <span class="text-[#46814F]">تعديل</span>
                                    </RouterLink >
                                    <button @click="showDeleteModal(location.id)" class="flex items-center gap-2">
